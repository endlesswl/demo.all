...
public class SqlParser implements PluginSqlUtil.Parser {
    private static final List<SelectItem> COUNT_ITEM;
    private static final Alias TABLE_ALIAS;
    private PluginSqlUtil.Parser simpleParser;
    ...
    public SqlParser(PluginSqlUtil.Dialect dialect) {
        simpleParser = PluginSqlUtil.SimpleParser.newParser(dialect);
    }
