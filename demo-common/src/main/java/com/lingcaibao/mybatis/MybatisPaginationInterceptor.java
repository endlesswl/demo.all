...
public class MybatisPaginationInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation inv) throws Throwable {
        ...
        // 查找方法参数中的 分页请求对象
        Pageable pageRequest = this
                .findPageableObject(queryArgs[PARAMETER_INDEX]);
        // 如果需要分页，验证参数中含有Pageable类型
        if (pageRequest != null) {
    ...
    private Pageable findPageableObject(Object params) {
        ...
        if (Pageable.class.isAssignableFrom(params.getClass())) {
            ...
            for (Map.Entry<String, Object> entry : paramMap.entrySet()) {
                ...
                if (null != paramValue && Pageable.class.isAssignableFrom(paramValue.getClass())) {
    ...
    private int queryTotal(String sql, MappedStatement mappedStatement,
        ...
        try {
            ...
            setParameters(countStmt, mappedStatement, countBoundSql,
                    boundSql.getParameterObject());
            ...
            if (connection != null) {
                try {
                    ...
                    logger.error("查询总记录数后关闭 connection 出错", e);
                }
            }
        }
