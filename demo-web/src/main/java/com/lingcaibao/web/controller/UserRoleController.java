...
import com.lingcaibao.service.UserRoleService;
...
public class UserRoleController {
	...
	public String list(
		...
		Page<UserRole> page = userRoleService.searchPage(searchParams, pageable);
	...
	public List<UserRole> listByJson(PageRequest pageRequest,
			ServletRequest request, Model model) throws ParseException {
		Map<String, Object> searchParams = Servlets.getParametersStartingWith(
				request, "s_");
		List<UserRole> list = userRoleService.search(searchParams);
		// 将搜索条件编码成字符串
		model.addAttribute("searchParams",
				Servlets.encodeParameterStringWithPrefix(searchParams, "s_"));
		return list;
	...
	public String createForm(Model model) {
		...
		return "userRole/userRoleForm";
	}

	@RequestMapping(value = "create", method = RequestMethod.POST)
	public String create(@Valid UserRole newUserRole,
			RedirectAttributes redirectAttributes) {
		userRoleService.insert(newUserRole);
	...
	public String updateForm(@PathVariable("id") Long id, Model model) {
		model.addAttribute("userRole", userRoleService.get(id));
		model.addAttribute("action", "update");
		return "userRole/userRoleForm";
	}

	@RequestMapping(value = "update", method = RequestMethod.POST)
	public String update(@Valid @ModelAttribute("userRole") UserRole userRole,
			RedirectAttributes redirectAttributes) {
