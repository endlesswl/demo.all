...
import com.lingcaibao.service.UserBakService;
 ...
 */
@Controller
@RequestMapping(value = "/admin/userBak")
public class UserBakController {
	private static Logger logger = LoggerFactory
			.getLogger(UserBakController.class);
	@Autowired
	...
	public String list(
		...
		Page<UserBak> page = userBakService.searchPage(searchParams, pageable);
		...
		return "userBak/userBakList";
	}

	@ResponseBody
	@RequestMapping(value = "/list")
	public List<UserBak> listByJson(PageRequest pageRequest,
			ServletRequest request, Model model) throws ParseException {
		Map<String, Object> searchParams = Servlets.getParametersStartingWith(
				request, "s_");
		List<UserBak> list = userBakService.search(searchParams);
		// 将搜索条件编码成字符串
		model.addAttribute("searchParams",
				Servlets.encodeParameterStringWithPrefix(searchParams, "s_"));
		return list;
	...
	public String createForm(Model model) {
		model.addAttribute("userBak", new UserBak());
		model.addAttribute("action", "create");
		return "userBak/userBakForm";
	}

	@RequestMapping(value = "create", method = RequestMethod.POST)
	public String create(@Valid UserBak newUserBak,
			RedirectAttributes redirectAttributes) {
		userBakService.insert(newUserBak);
		redirectAttributes.addFlashAttribute("message", "创建成功");
		return "redirect:/admin/userBak";
	}

	@RequestMapping(value = "update/{id}", method = RequestMethod.GET)
	public String updateForm(@PathVariable("id") Long id, Model model) {
		model.addAttribute("userBak", userBakService.get(id));
		model.addAttribute("action", "update");
		return "userBak/userBakForm";
	}

	@RequestMapping(value = "update", method = RequestMethod.POST)
	public String update(@Valid @ModelAttribute("userBak") UserBak userBak,
			RedirectAttributes redirectAttributes) {
		userBakService.update(userBak);
